...
document_number | String | '987654321, 678912345' | Номера выпущенных документов на билеты/услуги, по которыи запрашивается возврат в рамках заказа через запятую | Нет
